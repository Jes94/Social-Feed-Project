    ...
    return (
        <div className="grid-container">
            ...
            {props.parentPosts.map((post, index) => {
                ...
                <h6 className="main">{post.post}</h6>
                
                <h6 className="likes">
                    {/* Liking or Disliking one post effects all posts because all buttons are linked to the same value.*/}
                    <button onClick={likeFunction}  className={[likeActive ? 'active-like': 'button']}>
                    ...
                    <button onClick={dislikeFunction} className={[dislikeActive ? 'active-dislike': 'button']}>
